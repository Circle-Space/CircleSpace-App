...
import type { ImageProps, ImageSourcePropType, LayoutRectangle, ViewProps } from 'react-native';
...
import { AnimatableValue, AnimateProps, SharedValue } from 'react-native-reanimated';
...
export type ImageZoomProps = Omit<AnimateProps<ImageProps>, 'source'> & ZoomProps & {
    /**
...
export type ZoomableUseGesturesProps = Pick<ZoomableLayoutState, 'width' | 'height' | 'center'> & Pick<ZoomableProps, 'minScale' | 'maxScale' | 'scale' | 'doubleTapScale' | 'maxPanPointers' | 'isPanEnabled' | 'isPinchEnabled' | 'isSingleTapEnabled' | 'isDoubleTapEnabled' | 'onInteractionStart' | 'onInteractionEnd' | 'onPinchStart' | 'onPinchEnd' | 'onPanStart' | 'onPanEnd' | 'onSingleTap' | 'onDoubleTap' | 'onProgrammaticZoom' | 'onResetAnimationEnd'>;
