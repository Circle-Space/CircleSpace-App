...
export const useGestures = _ref => {
  ...
  const reset = useCallback(() => {
    ...
    scale.value = withTiming(1, withTimingConfig, function () {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return onAnimationEnd(interactionId, ANIMATION_VALUE.SCALE, lastScaleValue, ...args);
    });
    ...
    focal.x.value = withTiming(0, withTimingConfig, function () {
      for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        args[_key2] = arguments[_key2];
      }
      return onAnimationEnd(interactionId, ANIMATION_VALUE.FOCAL_X, lastFocalXValue, ...args);
    });
    const lastFocalYValue = focal.y.value;
    focal.y.value = withTiming(0, withTimingConfig, function () {
      for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
        args[_key3] = arguments[_key3];
      }
      return onAnimationEnd(interactionId, ANIMATION_VALUE.FOCAL_Y, lastFocalYValue, ...args);
    });
    savedTranslate.x.value = 0;
    savedTranslate.y.value = 0;
    const lastTranslateXValue = translate.x.value;
    translate.x.value = withTiming(0, withTimingConfig, function () {
      for (var _len4 = arguments.length, args = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
        args[_key4] = arguments[_key4];
      }
      return onAnimationEnd(interactionId, ANIMATION_VALUE.TRANSLATE_X, lastTranslateXValue, ...args);
    });
    const lastTranslateYValue = translate.y.value;
    translate.y.value = withTiming(0, withTimingConfig, function () {
      for (var _len5 = arguments.length, args = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
        args[_key5] = arguments[_key5];
      }
      return onAnimationEnd(interactionId, ANIMATION_VALUE.TRANSLATE_Y, lastTranslateYValue, ...args);
    });
