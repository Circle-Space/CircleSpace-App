...
interface PinnedReviewsVerticalProps {
  userId: string;
  onStatsUpdate?: (stats: any) => void;
  route: any;
}

const PinnedReviewsVertical = ({ userId, onStatsUpdate, route }: PinnedReviewsVerticalProps) => {
  ...
  const checkUserPermission = async () => {
    try {
      ...
      if (userData) {
        ...
        setCanEdit(parsedUser._id === userId);
      }
    } catch (error) {
      ...
      <View style={styles.reviewHeader}>
        ...
        {canEdit && (
          <View style={styles.actionButtons}>
            <TouchableOpacity
              onPress={() => handleUnpin(review._id)}
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {pinnedReviews.map((review) => renderReviewCard(review))}
      </ScrollView>
    </View>
  );
};
...
export default PinnedReviewsVertical; 