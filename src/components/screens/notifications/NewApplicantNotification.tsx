...
interface NewApplicantNotificationCardProps {
  notification: Notification;
}
const NewApplicantNotificationCard: React.FC<NewApplicantNotificationCardProps> = ({
  notification,
}) => {
  // console.log('NewApplicantNotificationCard', notification);
    ...
    <Pressable
      ...
      <Text
       ...
       {notification?.title}
        ...
        {notification?.message}  {<RealtiveTime updatedAt={notification?.createdAt} />}
      </Text>
      <TouchableOpacity
        onPress={() => {
        //   followUser();
...
export default NewApplicantNotificationCard;
