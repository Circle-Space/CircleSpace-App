...
const ChatOptionModal: React.FC<ChatOptionModalProps> = ({
  visible,
  setVisible,
  ...
  //'Clear Chat'
  const list = fromPrivateChat
    ? ['Report', blocked ? 'Unblock' : 'Block', 'Cancel','Clear Chat']
    : ['Report', blocked ? 'Unblock' : 'Block', 'Cancel','Delete'];
